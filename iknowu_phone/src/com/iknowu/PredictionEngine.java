...
import com.iknowu.swipe.Swipe.Sw_Node;
...
public class PredictionEngine {
   ...
   // load the library - name matches jni/Android.mk
	...
	public int advanceLetterSwipe( Sw_Node[] nPath) {
        Log.i(TAG, "PE.advanceLetterSwipe : candidatePath = |" + IKnowUKeyboardView.swiper.printPath()); // TODO - remove
	...
	public int advanceWordComplete( String candidatePred, boolean replace) {
        Log.i(TAG, "PE.advanceWordComplete : candidatePred = |" + candidatePred + "| replace = " + replace); // TODO - remove
	...
	public boolean backspaceLetter() {
        Log.i(TAG, "PE.backspaceLetter : "); // TODO - remove
		boolean b = ntvBackspaceLetter(m_nextWordsInfo);
		return b;
	}
	
	public boolean isChunk(String candidatePred) {
        Log.i(TAG, "PE.isChunk : candidatePred = |" + candidatePred + "|"); // TODO - remove
	...
	*/
    ...
    public int getNumNextWords() {
        Log.i(TAG, "PE.getNumNextWords : "); // TODO - remove
