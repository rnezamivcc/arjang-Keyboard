...
UIImage *scroll_indicator_default_image(UIScrollView *scrollView, int indicatorType)
{
    ...
    switch (scrollView.indicatorStyle) {
        case UIScrollViewIndicatorStyleDefault:
            image = [UIImage imageWithData:[NSData dataWithBytes:defaultPNGData length:ARRAY_SIZE(defaultPNGData)] scale:2];
            break;
        case UIScrollViewIndicatorStyleBlack:
            image = [UIImage imageWithData:[NSData dataWithBytes:blackPNGData length:ARRAY_SIZE(blackPNGData)] scale:2];
            break;
        case UIScrollViewIndicatorStyleWhite:
            image = [UIImage imageWithData:[NSData dataWithBytes:whitePNGData length:ARRAY_SIZE(whitePNGData)] scale:2];
            break;
    }
